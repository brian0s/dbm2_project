...
with open("2021-2022 Football Team Stats.csv", "r", encoding='utf-8', errors='replace') as f:
    data = f.readlines()
...
with open("clubs_cleaned_21-22.csv", "w", encoding='utf-8', errors='replace') as f_write:
