...
with open("2022-2023 Football Player Stats.csv", "r", encoding='utf-8', errors='replace') as f:
    data = f.readlines()
...
with open("players_cleaned_22-23.csv", "w", encoding='utf-8', errors='replace') as f_write:
